...
public class QaGuruTests {
    ...
    public void registrationCheck() {
        LOGGER.info("This test will check registration successful path");
        ...
        Assertions.assertEquals(SUCCESS_TXT, successPage.getSuccessMsg(), ("Problem with success message!"));
    }
